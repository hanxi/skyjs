 ...
 * Makefile via qjsc from js/skynet.js, js/internal/net-core.js, js/internal/crypt-core.js,
 * builtins/skyjs/cluster.js, builtins/skyjs/gateserver.js, internal/http-core.js and js/websocket.js;
 * see build/rt_bc.c).
